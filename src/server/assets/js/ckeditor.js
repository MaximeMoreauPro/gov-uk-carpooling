    ...
    (() => {
      ...
      function a(t, e) {
        ...
        for (let i = 0; i < t.length; i++)
          if (r.get(t[i].priority) < n) return void t.splice(i, 0, e);
        t.push(e);
      }
          ...
          stopListening(t, e, n) {
            ...
            if (!(!i || (t && !o) || (e && !r)))
              if (n) {
                C(this, t, e, n);
                -1 !== r.indexOf(n) &&
                  (1 === r.length ? delete o.callbacks[e] : C(this, t, e, n));
              } else if (r) {
        ...
        return class extends t {
          set(t, e) {
            ...
            if (t in this && !n.has(t))
              throw new l('observable-set-cannot-override', this);
          ...
          bind(...t) {
            if (!t.length || !B(t))
              throw new l('observable-bind-wrong-properties', this);
            if (new Set(t).size !== t.length)
              throw new l('observable-bind-duplicate-properties', this);
            N(this);
            const e = this[S];
            t.forEach(t => {
          ...
          unbind(...t) {
            ...
            if (t.length) {
              if (!B(t))
                throw new l('observable-unbind-wrong-properties', this);
              t.forEach(t => {
                const i = e.get(t);
                i &&
                  (i.to.forEach(([t, e]) => {
          ...
          decorate(t) {
            ...
            const e = this[t];
            if (!e)
              throw new l('observablemixin-cannot-decorate-undefined', this, {
                object: this,
                methodName: t,
              });
            this.on(t, (t, n) => {
      ...
      function D(...t) {
            ...
            return (
              t.forEach(t => {
                if ('string' == typeof t) n.properties.push(t);
                  ...
                  if ('object' != typeof t)
                    throw new l('observable-bind-to-parse-error', null);
        ...
        if (!e.callback && e.to.length > 1)
          throw new l('observable-bind-to-no-callback', this);
        if (i > 1 && e.callback)
          throw new l('observable-bind-to-extra-callback', this);
        var s;
        e.to.forEach(t => {
          ...
          (function (t) {
            ...
            t._bindings.forEach((n, i) => {
              t._to.forEach(s => {
                (e =
                  s.properties[n.callback ? 0 : t._bindProperties.indexOf(i)]),
      ...
      function F(t, e, n) {
        if (this._bindings.size > 1)
          throw new l('observable-bind-to-many-not-one-binding', this);
        this.to(
          ...(function (t, e) {
            const n = t.map(t => [t, e]);
        ...
        forceDisabled(t) {
          this._disableStack.add(t),
            1 == this._disableStack.size &&
              (this.on('set:isEnabled', W, { priority: 'highest' }),
              (this.isEnabled = !1));
        }
        clearForceDisabled(t) {
          this._disableStack.delete(t),
            0 == this._disableStack.size &&
              (this.off('set:isEnabled', W), (this.isEnabled = !0));
        }
        destroy() {
          this.stopListening();
        }
      ...
      class $ {
        ...
        forceDisabled(t) {
          this._disableStack.add(t),
            1 == this._disableStack.size &&
              (this.on('set:isEnabled', z, { priority: 'highest' }),
              (this.isEnabled = !1));
        }
        clearForceDisabled(t) {
          this._disableStack.delete(t),
            0 == this._disableStack.size &&
              (this.off('set:isEnabled', z), this.refresh());
        }
        execute() {}
        destroy() {
          this.stopListening();
      ...
      const pt = function (t) {
        ...
        return (
          !(n < 0) &&
          (n == e.length - 1 ? e.pop() : gt.call(e, n, 1), --this.size, !0)
        );
      };
      const _t = function (t) {
        var e = this.__data__,
      ...
      const Jt = function (t, e) {
        ...
        return (
          ...
          (n[t] = $t && void 0 === e ? '__lodash_hash_undefined__' : e),
          this
        );
      };
      function Yt(t) {
      ...
      const Ze = function (t) {
        ...
        var e = ze(t),
          n = [];
        for (var i in t)
          ('constructor' != i || (!e && Xe.call(t, i))) && n.push(i);
        return n;
      };
      const Qe = function (t) {
      ...
      const ai = function t(e, n, i, s, o, r) {
        ...
        if (d) {
          ...
          if (u == oi || u == ii || (f && !o)) {
            if (((a = c || f ? {} : Yn(e)), !l))
              return c ? pn(e, tn(a, e)) : fn(e, Je(a, e));
          } else {
            if (!ri[u]) return o ? e : {};
            a = Kn(e, u, l);
          }
      ...
      class mi extends w {
        ...
        addMany(t, e) {
          if (void 0 === e) e = this._items.length;
            ...
            throw new l('collection-add-item-invalid-index', this);
          let n = 0;
          for (const i of t) {
        ...
        get(t) {
          ...
          if ('string' == typeof t) e = this._itemMap.get(t);
            ...
            if ('number' != typeof t)
              throw new l('collection-get-invalid-arg', this);
            e = this._items[t];
          }
          return e || null;
        }
        ...
        bindTo(t) {
          if (this._bindToCollection)
            throw new l('collection-bind-to-rebind', this);
          return (
        ...
        _getItemIdBeforeAdding(t) {
          ...
          if (e in t) {
            if (((n = t[e]), 'string' != typeof n))
              throw new l('collection-add-invalid-id', this);
            if (this.get(n))
              throw new l('collection-add-item-already-exists', this);
          } else t[e] = n = o();
          return n;
        }
        _remove(t) {
      ...
      class gi {
        ...
        *[Symbol.iterator]() {
        ...
        get(t) {
          ...
          if (!e) {
            ...
            throw (
              ...
              new l('plugincollection-plugin-not-loaded', this._context, {
                plugin: e,
              }))
            );
          }
        ...
        init(t, e = [], n = []) {
          ...
          function u(t, n = null) {
            t.map(t => (a(t) ? t : i._availablePlugins.get(t) || t)).forEach(
              t => {
                !(function (t, e) {
                  if (a(t)) return;
                  if (e)
                    throw new l('plugincollection-soft-required', s, {
                      missingPlugin: t,
                      requiredBy: d(e),
                    });
                  throw new l('plugincollection-plugin-not-found', s, {
                    plugin: t,
                  });
                })(t, n),
                  (function (t, e) {
                    if (!c(e)) return;
                    if (c(t)) return;
                    throw new l('plugincollection-context-required', s, {
                      plugin: d(t),
                      requiredBy: d(e),
                    });
                  })(t, n),
                  (function (t, n) {
                    if (!n) return;
                    if (!h(t, e)) return;
                    throw new l('plugincollection-required', s, {
                      plugin: d(t),
                      requiredBy: d(n),
                    });
                  })(t, n);
      ...
      function bi(t, e, n = 1) {
        if ('number' != typeof n)
          throw new l('translation-service-quantity-not-a-number', null, {
            quantity: n,
          });
        ...
        if (
          ...
          !(function (t, e) {
            return (
              !!wi.window.CKEDITOR_TRANSLATIONS[t] &&
              !!wi.window.CKEDITOR_TRANSLATIONS[t].dictionary[e]
            );
          })(t, s)
        )
        ...
        const o = wi.window.CKEDITOR_TRANSLATIONS[t].dictionary,
          r =
            wi.window.CKEDITOR_TRANSLATIONS[t].getPluralForm ||
            (t => (1 === t ? 0 : 1)),
          a = o[s];
      ...
      class ki {
        ...
        initPlugins() {
          ...
          for (const n of t.concat(e)) {
            if ('function' != typeof n)
              throw new l('context-initplugins-constructor-only', null, {
                Plugin: n,
              });
            if (!0 !== n.isContextPlugin)
              throw new l('context-initplugins-invalid-plugin', null, {
                Plugin: n,
              });
          }
        ...
        _addEditor(t, e) {
          if (this._contextOwner)
            throw new l('context-addeditor-private-context');
      ...
      class xi extends _(Ci) {
        ...
        get index() {
          ...
          if (-1 == (t = this.parent.getChildIndex(this)))
            throw new l('view-node-not-found-in-parent', this);
          return t;
        }
        get nextSibling() {
          const t = this.index;
      ...
      class Ri extends Ci {
        constructor(t, e, n) {
          ...
          if (n < 0 || e + n > t.data.length)
            throw new l('view-textproxy-wrong-length', this);
        ...
        return (e.name &&
          ...
          (e.attributes &&
            ((n.attributes = (function (t, e) {
              ...
              dt(t)
                ? (void 0 !== t.style &&
                    c('matcher-pattern-deprecated-attributes-style-key', t),
                  void 0 !== t.class &&
                    c('matcher-pattern-deprecated-attributes-class-key', t))
              ...
              return t.map(t =>
                dt(t)
                  ? ((void 0 !== t.key && void 0 !== t.value) ||
                      c('matcher-pattern-missing-key-or-value', t),
                    [t.key, t.value])
                  : [t, !0]
              );
      ...
      const Qi = function (t, e) {
        for (var n = 0, i = (e = Yi(e, t)).length; null != t && n < i; )
          t = t[Zi(e[n++])];
      ...
      const os = function (t, e, n) {
        ((void 0 !== n && !ft(t[e], n)) || (void 0 === n && !(e in t))) &&
          ue(t, e, n);
      };
      const rs = (function (t) {
      ...
      const gs = function (t, e, n) {
        return (
          ...
          function () {
            for (
              var i = arguments, s = -1, o = ms(i.length - e, 0), r = Array(o);
              ++s < o;
      ...
      const Cs = function (t, e, n, i) {
        if (!E(t)) return t;
        for (
          var s = -1, o = (e = Yi(e, t)).length, r = o - 1, a = t;
          null != a && ++s < o;
      ...
      class Os extends xi {
        ...
        *getCustomProperties() {
        ...
        _setStyle(t, e) {
          this._fireChange('attributes', this),
            dt(t) ? this._styles.set(t) : this._styles.set(t, e);
        }
        _removeStyle(t) {
          this._fireChange('attributes', this);
      ...
      class Vs {
        constructor(t = {}) {
          if (!t.boundaries && !t.startPosition)
            throw new l('view-tree-walker-no-start-position', null);
          if (
            t.direction &&
            'forward' != t.direction &&
            'backward' != t.direction
          )
            throw new l('view-tree-walker-unknown-direction', t.startPosition, {
              direction: t.direction,
            });
          (this.boundaries = t.boundaries || null),
            t.startPosition
              ? (this.position = Ls._createAt(t.startPosition))
              : (this.position = Ls._createAt(
        ...
        _next() {
          ...
          if (n instanceof Si) {
            if (t.isAtEnd)
              return (this.position = Ls._createAfter(n)), this._next();
            i = n.data[t.offset];
          ...
          if (i instanceof Si) {
            if (this.singleCharacters)
              return (t = new Ls(i, 0)), (this.position = t), this._next();
            {
              let n,
                s = i.data.length;
              return (
                i == this._boundaryEndParent
                  ? ((s = this.boundaries.end.offset),
                    (n = new Ri(i, 0, s)),
                    (t = Ls._createAfter(n)))
        ...
        _previous() {
          ...
          if (n instanceof Si) {
            if (t.isAtStart)
              return (this.position = Ls._createBefore(n)), this._previous();
            i = n.data[t.offset - 1];
          ...
          if (i instanceof Si) {
              ...
              );
            {
              ...
              if (i == this._boundaryStartParent) {
                ...
                (n = new Ri(i, e, i.data.length - e)),
                  (s = n.data.length),
                  (t = Ls._createBefore(n));
              } else (n = new Ri(i, 0, i.data.length)), t.offset--;
              return (
                (this.position = t), this._formatReturnValue('text', n, e, t, s)
              );
            }
          }
          if ('string' == typeof i) {
      ...
      class Ls extends Ci {
        ...
        static _createAt(t, e) {
          if (t instanceof Ls) return new this(t.parent, t.offset);
          {
            ...
            if ('end' == e) e = n.is('$text') ? n.data.length : n.childCount;
              ...
              if (0 !== e && !e)
                throw new l('view-createpositionat-offset-required', n);
            }
            return new Ls(n, e);
          }
        }
        static _createAfter(t) {
          if (t.is('$textProxy'))
            return new Ls(t.textNode, t.offsetInText + t.data.length);
          if (!t.parent)
            throw new l('view-position-after-root', t, { root: t });
          return new Ls(t.parent, t.index + 1);
        }
        static _createBefore(t) {
          if (t.is('$textProxy')) return new Ls(t.textNode, t.offsetInText);
          if (!t.parent)
            throw new l('view-position-before-root', t, { root: t });
        ...
        *[Symbol.iterator]() {
        ...
        getEnlarged() {
          ...
          return (
            t.parent.is('$text') &&
              t.isAtStart &&
              (t = Ls._createBefore(t.parent)),
            e.parent.is('$text') &&
              e.isAtEnd &&
              (e = Ls._createAfter(e.parent)),
            new js(t, e)
          );
        }
        getTrimmed() {
          ...
          let e = this.end.getLastMatchingPosition(Ws, {
            direction: 'backward',
          });
          const n = t.nodeAfter,
            i = e.nodeBefore;
          return (
            n && n.is('$text') && (t = new Ls(n, 0)),
            i && i.is('$text') && (e = new Ls(i, i.data.length)),
            new js(t, e)
          );
        }
        isEqual(t) {
        ...
        getDifference(t) {
          ...
          return (
            this.isIntersecting(t)
              ? (this.containsPosition(t.start) &&
                  e.push(new js(this.start, t.start)),
        ...
        *getRanges() {
        ...
        setTo(...t) {
          ...
          if (('object' == typeof n && ((i = n), (n = void 0)), null === e))
            ...
            this._setRanges([new js(e)]), this._setFakeOptions(i);
            ...
            (s =
              'in' == n
                ...
                : 'on' == n
                ? js._createOn(e)
                : new js(Ls._createAt(e, n))),
              this._setRanges([s], t),
              this._setFakeOptions(i);
          } else {
            if (!fi(e))
              throw new l('view-selection-setto-not-selectable', this);
            this._setRanges(e, i && i.backward), this._setFakeOptions(i);
          }
          this.fire('change');
        }
        setFocus(t, e) {
          if (null === this.anchor)
            throw new l('view-selection-setfocus-no-ranges', this);
          const n = Ls._createAt(t, e);
          if ('same' == n.compareWith(this.focus)) return;
          const i = this.anchor;
          this._ranges.pop(),
            'before' == n.compareWith(i)
              ? this._addRange(new js(n, i), !0)
              : this._addRange(new js(i, n)),
            this.fire('change');
        }
        _setRanges(t, e = !1) {
        ...
        _addRange(t, e = !1) {
          if (!(t instanceof js))
            throw new l('view-selection-add-range-not-range', this);
          this._pushRange(t), (this._lastRangeBackward = !!e);
        }
        _pushRange(t) {
          for (const e of this._ranges)
            if (t.isIntersecting(e))
              throw new l('view-selection-range-intersects', this, {
                addedRange: t,
                intersectingRange: e,
              });
          ...
          fire(t, ...e) {
            try {
              const n = t instanceof i ? t : new i(this, t),
                s = Xs(this);
              if (!s.size) return;
              if ((Gs(n, 'capturing', this), Js(s, '$capture', n, ...e)))
                return n.return;
              ...
              for (; l; ) {
                ...
                } else if (l.is('element') && Js(s, l.name, n, ...e))
                  return n.return;
                if (Js(s, l, n, ...e)) return n.return;
                (l = l.parent), Gs(n, 'bubbling', l);
              }
              return (
                Gs(n, 'bubbling', this), Js(s, '$document', n, ...e), n.return
              );
            } catch (t) {
              l.rethrowUnexpectedError(t, this);
            }
      ...
      class no extends Os {
        ...
        _insertChild(t, e) {
          if (e && (e instanceof xi || Array.from(e).length > 0))
            throw new l('view-emptyelement-cannot-add', [this, e]);
          return 0;
        }
      }
      function io() {
        ...
        oo = {
          ...
          isiOS: (function (t) {
            return (
              ...
              (ao(t) && navigator.maxTouchPoints > 0)
            );
          })(so),
      ...
      function fo(t) {
        let e;
        if ('string' == typeof t) {
          if (((e = ho[t.toLowerCase()]), !e))
            throw new l('keyboard-unknown-key', null, { key: t });
        } else
          e =
            t.keyCode +
            (t.altKey ? ho.alt : 0) +
      ...
      class _o extends Os {
        ...
        _insertChild(t, e) {
          if (e && (e instanceof xi || Array.from(e).length > 0))
            throw new l('view-uielement-cannot-add', [this, e]);
          return 0;
        }
        render(t, e) {
      ...
      class yo extends Os {
        ...
        _insertChild(t, e) {
          if (e && (e instanceof xi || Array.from(e).length > 0))
            throw new l('view-rawelement-cannot-add', [this, e]);
          return 0;
        }
        render() {}
      }
      ...
      class ko {
        ...
        mergeAttributes(t) {
          ...
          if (n.is('attributeElement') && 0 === n.childCount) {
            ...
            return (
              ...
              this.mergeAttributes(new Ls(t, e))
            );
          }
        ...
        mergeContainers(t) {
          ...
          const i = e.getChild(e.childCount - 1),
            s =
              i instanceof Si ? Ls._createAt(i, 'end') : Ls._createAt(e, 'end');
          return (
            this.move(js._createIn(n), Ls._createAt(e, 'end')),
            this.remove(js._createOn(n)),
            s
          );
        }
        insert(t, e) {
        ...
        remove(t) {
          ...
          if ((Io(e, this.document), e.isCollapsed))
            return new Po(this.document);
        ...
        wrap(t, e) {
          if (!(e instanceof Qs))
            throw new l('view-writer-wrap-invalid-attribute', this.document);
          if ((Io(t, this.document), t.isCollapsed)) {
            ...
            return (
              s.isCollapsed &&
                s.getFirstPosition().isEqual(t.start) &&
                this.setSelection(i),
              new js(i)
            );
          }
        ...
        unwrap(t, e) {
          if (!(e instanceof Qs))
            throw new l('view-writer-unwrap-invalid-attribute', this.document);
        ...
        _breakAttributes(t, e = !1) {
          ...
          if (t.parent.is('uiElement'))
            throw new l('view-writer-cannot-break-ui-element', this.document);
          if (t.parent.is('rawElement'))
            throw new l('view-writer-cannot-break-raw-element', this.document);
      ...
      function To(t) {
        if (t.offset == t.parent.data.length)
          return new Ls(t.parent.parent, t.parent.index + 1);
      ...
      function Ro(t, e) {
        for (const n of t) {
          if (!So.some(t => n instanceof t))
            throw new l('view-writer-insert-invalid-node-type', e);
      ...
      function Io(t, e) {
        const n = Ao(t.start),
          i = Ao(t.end);
        if (!n || !i || n !== i)
          throw new l('view-writer-invalid-range-container', e);
      }
      function Mo(t, e) {
      ...
      function Ho(t, e, n) {
        ...
        function u(i) {
          const s = (void 0 !== d[i - 1] ? d[i - 1] : -1) + 1,
            ...
            u = s > c ? -1 : 1;
          h[i + u] && (h[i] = h[i + u].slice(0)),
            h[i] || (h[i] = []),
            h[i].push(s > c ? o : r);
          let f = Math.max(s, c),
            m = f - i;
          for (; m < a && f < l && n(t[m], e[f]); )
            m++, f++, h[i].push('equal');
          return f;
        }
        let f,
      ...
      class Xo extends M {
        ...
        markToSync(t, e) {
          if ('text' === t)
            ...
            if ('attributes' === t) this.markedAttributes.add(e);
              ...
              if ('children' !== t)
                throw new l('view-renderer-unknown-type', this);
          ...
          if (e)
            if (t) {
              ...
              Lo(e.parent)
                ...
                : (this._inlineFiller = Zo(n, e.parent, e.offset));
            ...
            for (const o of s)
              if ('replace' === o) {
                ...
                !r ||
                  r.is('uiElement') ||
                  r.is('rawElement') ||
                  this._updateElementMappings(r, e[o]),
                  Go(n[s]),
                  i.equal++;
              } else i[o]++;
          }
        ...
        _removeInlineFiller() {
          ...
          jo(t) ? t.remove() : (t.data = t.data.substr(7)),
            (this._inlineFiller = null);
        }
        ...
        _updateText(t, e) {
          ...
          if (
            (r && r.parent == t.parent && r.offset == t.index && (o = Vo + o),
            s != o)
          ) {
            const t = zo(s, o);
            for (const e of t)
        ...
        _updateChildren(t, e) {
          ...
          const l = new Set();
          for (const t of r)
            'delete' === t ? (l.add(s[a]), Go(s[a])) : 'equal' === t && a++;
          a = 0;
          for (const t of r)
            'insert' === t
              ? (Ko(n, a, o[a]), a++)
        ...
        _findReplaceActions(t, e, n) {
          ...
          for (const a of t)
            'insert' === a
              ...
              : ((i = i.concat(
                  Ho(s, o, Qo).map(t => ('equal' === t ? 'replace' : t))
                )),
                i.push('equal'),
                (s = []),
                (o = [])),
      ...
      class lr {
          ...
          (this.document = t),
            ...
            (this._domDocument =
              'editing' === this.renderingMode
                ? wi.document
                : wi.document.implementation.createHTMLDocument('')),
        ...
        setContentOf(t, e) {
          ...
          for (const t of r) {
            ...
            this._shouldRenameElement(e) &&
              (dr(e), t.replaceWith(this._createReplacementDomElement(e, t)));
          }
        ...
        viewToDom(t, e = {}) {
          ...
          }
          {
            ...
            if (!1 !== e.withChildren)
              for (const i of this.viewChildrenToDom(t, e)) n.appendChild(i);
            return n;
          }
        }
        setDomElementAttribute(t, e, n, i) {
          ...
          s ||
            c('domconverter-unsafe-attribute-detected', {
              domElement: t,
              key: e,
              value: n,
            }),
            t.hasAttribute(e) && !s
              ? t.removeAttribute(e)
              : t.hasAttribute(rr + e) && s && t.removeAttribute(rr + e),
        ...
        *viewChildrenToDom(t, e = {}) {
          ...
          for (const s of t.getChildren()) {
            ...
            const t =
              s.is('element') &&
              s.getCustomProperty('dataPipeline:transparentRendering');
        ...
        *domChildrenToView(t, e) {
        ...
        _shouldRenameElement(t) {
          ...
          return (
            'editing' === this.renderingMode && this.unsafeElements.includes(e)
          );
        }
      ...
      const Fr = function (t, e, n, i, s, o) {
        ...
        if (u && !h)
          return (
            o || (o = new ce()),
            r || Le(t) ? Ar(t, e, n, i, s, o) : Sr(t, e, l, n, i, s, o)
          );
        if (!(1 & n)) {
      ...
      class ia extends _r {
        ...
        _handleSelectionMove(t) {
          ...
          (t != ho.arrowleft && t != ho.arrowup) ||
            n.setTo(n.getFirstPosition()),
            (t != ho.arrowright && t != ho.arrowdown) ||
      ...
      class sa extends _r {
        constructor(t) {
          super(t),
            ...
            (this._documentIsSelectingInactivityTimeoutDebounced = na(
      ...
      class ca {
        ...
        static _deleteElementCallback(t, e) {
          ...
          n &&
            (n.delete(e),
            n.size ||
              (ca._elementCallbacks.delete(t),
              ca._observerInstance.unobserve(t))),
      ...
      class ua extends fr(M) {
        ...
        add(t) {
          if (this._elements.has(t))
            throw new l('focustracker-add-element-already-exist', this);
      ...
      class ba {
        ...
        getIntersection(t) {
          ...
          return (
            ...
            e.width < 0 || e.height < 0 ? null : new ba(e)
          );
        }
      ...
      function ka(t, e, n) {
        ...
        if (![s, i].every(t => o.contains(t))) {
          ...
          Ea(s, o)
            ? (a -= o.top - e.top + n)
            : Ca(i, o) && (a += e.bottom - o.bottom + n),
            Ta(e, o)
              ? (r -= o.left - e.left + n)
              : xa(e, o) && (r += e.right - o.right + n),
            t.scrollTo(r, a);
        }
      }
      function Aa(t, e) {
          ...
          (s = e()),
            ...
            i.contains(s) ||
              (Ea(s, i)
                ...
                : Ca(s, i) && (t.scrollTop += s.bottom - i.bottom),
              Ta(s, i)
                ? (t.scrollLeft -= i.left - s.left)
                : xa(s, i) && (t.scrollLeft += s.right - i.right)),
            (t = t.parentNode);
      }
      function Ca(t, e) {
      ...
      class Ia extends M {
        ...
        change(t) {
          if (this.isRenderingInProgress || this._postFixersInProgress)
            throw new l('cannot-change-view-tree', this);
          try {
      ...
      class Na extends Ma {
        ...
        get index() {
          ...
          if (null === (t = this.parent.getChildIndex(this)))
            throw new l('model-node-not-found-in-parent', this);
          return t;
        }
        get startOffset() {
          let t;
      ...
      class Da {
        ...
        offsetToIndex(t) {
          ...
          if (e != t)
            throw new l('model-nodelist-offset-out-of-bounds', this, {
              offset: t,
              nodeList: this,
            });
          return this.length;
        ...
        _insertNodes(t, e) {
          for (const t of e)
            if (!(t instanceof Na))
              throw new l('model-nodelist-insertnodes-not-node', this);
      ...
      class Ba extends Ma {
        constructor(t, e, n) {
          ...
          if (n < 0 || e + n > t.offsetSize)
            throw new l('model-textproxy-wrong-length', this);
          (this.data = t.data.substring(e, e + n)), (this.offsetInText = e);
        }
        get startOffset() {
        ...
        static fromJSON(t) {
          ...
          if (t.children) {
            ...
            for (const n of t.children)
              n.name ? e.push(Va.fromJSON(n)) : e.push(Fa.fromJSON(n));
          }
      ...
      class La {
        constructor(t = {}) {
          if (!t.boundaries && !t.startPosition)
            throw new l('model-tree-walker-no-start-position', null);
          const e = t.direction || 'forward';
          if ('forward' != e && 'backward' != e)
            throw new l('model-tree-walker-unknown-direction', t, {
              direction: e,
            });
          (this.direction = e),
            (this.boundaries = t.boundaries || null),
        ...
        _next() {
          ...
          if (s instanceof Va)
            return (
              this.shallow
                ? e.offset++
                : (e.path.push(0), (this._visitedParent = s)),
              (this.position = e),
      ...
      class Wa extends Ma {
        constructor(t, e, n = 'toNone') {
          if ((super(), !t.is('element') && !t.is('documentFragment')))
            throw new l('model-position-root-invalid', t);
        ...
        get parent() {
          ...
          for (let e = 0; e < this.path.length - 1; e++)
            if (((t = t.getChild(t.offsetToIndex(this.path[e]))), !t))
              throw new l('model-position-path-incorrect', this, {
                position: this,
              });
          if (t.is('$text'))
            throw new l('model-position-path-incorrect', this, {
        ...
        static _createAt(t, e, n = 'toNone') {
          if (t instanceof Wa) return new Wa(t.root, t.path, t.stickiness);
          {
            ...
            if ('end' == e) e = i.maxOffset;
              ...
              if (0 !== e && !e)
                throw new l('model-createpositionat-offset-required', [
                  this,
                  t,
                ]);
            }
            if (!i.is('element') && !i.is('documentFragment'))
              throw new l('model-position-parent-incorrect', [this, t]);
            const s = i.getPath();
        ...
        static _createAfter(t, e) {
          if (!t.parent)
            throw new l('model-position-after-root', [this, t], { root: t });
          return this._createAt(t.parent, t.endOffset, e);
        }
        static _createBefore(t, e) {
          if (!t.parent)
            throw new l('model-position-before-root', t, { root: t });
        ...
        static fromJSON(t, e) {
          ...
          if (!e.getRoot(t.root))
            throw new l('model-position-fromjson-no-root', e, {
              rootName: t.root,
            });
      ...
      class Ua extends Ma {
        ...
        *[Symbol.iterator]() {
        ...
        get isFlat() {
          return (
            'same' == Ei(this.start.getParentPath(), this.end.getParentPath())
          );
        }
        get root() {
          return this.start.root;
        ...
        getDifference(t) {
          ...
          return (
            this.isIntersecting(t)
              ? (this.containsPosition(t.start) &&
                  e.push(new Ua(this.start, t.start)),
        ...
        getMinimalFlatRanges() {
          ...
          for (; n.path.length > e + 1; ) {
            ...
            0 !== e && t.push(new Ua(n, n.getShiftedBy(e))),
              (n.path = n.path.slice(0, -1)),
              n.offset++,
              (i = i.parent);
          }
          for (; n.path.length <= this.end.path.length; ) {
            const e = this.end.path[n.path.length - 1],
              i = e - n.offset;
            0 !== i && t.push(new Ua(n, n.getShiftedBy(i))),
              (n.offset = e),
              n.path.push(0);
          }
          return t;
        ...
        *getPositions(t = {}) {
        ...
        _getTransformedByMove(t, e, n, i = !1) {
          ...
          if (
            ...
            const t = new Ua(
              c.start._getCombined(s.start, o),
              c.end._getCombined(s.start, o)
            );
        ...
        _getTransformedByDeletion(t, e) {
          ...
          return null == n && null == i
            ? null
            : (null == n && (n = t), null == i && (i = t), new Ua(n, i));
        }
        static _createFromPositionAndShift(t, e) {
          const n = t,
            i = t.getShiftedBy(e);
        ...
        static _createFromRanges(t) {
          if (0 === t.length)
            throw new l('range-create-from-ranges-empty-array', null);
          ...
          if (n > 0)
            for (let e = n - 1; t[e].end.isEqual(i.start); e++)
              i.start = Wa._createAt(t[e].start);
          for (let e = n + 1; e < t.length && t[e].start.isEqual(i.end); e++)
            i.end = Wa._createAt(t[e].end);
          return i;
        }
        static fromJSON(t, e) {
      ...
      class Ha extends w {
        ...
        unbindElementFromMarkerName(t, e) {
          ...
          n &&
            (n.delete(t), 0 == n.size && this._markerNameToElements.delete(e));
          const i = this._elementToMarkerNames.get(t);
          i &&
            (i.delete(e), 0 == i.size && this._elementToMarkerNames.delete(t));
        }
        ...
        findPositionIn(t, e) {
          ...
          for (; s < e; )
            (n = t.getChild(o)), (i = this.getModelLength(n)), (s += i), o++;
          return s == e
            ? this._moveViewPositionToTextNode(new Ls(t, o))
        ...
        verifyAllConsumed(t) {
          ...
          for (const [n, i] of this._consumable)
            for (const [s, o] of i) {
              ...
              o &&
                t == i &&
                e.push({ event: s, item: n.name || n.description });
            }
          if (e.length)
            throw new l('conversion-model-consumable-not-consumed', null, {
              items: e,
            });
        }
      ...
      class Ja extends w {
        ...
        convertChanges(t, e, n) {
          ...
          for (const t of s)
            'insert' === t.type
              ? this._convertInsert(
                  Ua._createFromPositionAndShift(t.position, t.length),
                  i
                )
              : 'reinsert' === t.type
        ...
        convertSelection(t, e, n) {
          ...
          if (
            ...
            for (const e of i) {
              ...
              s.consumable.test(t, 'addMarker:' + e.name) &&
                this.fire(`addMarker:${e.name}`, i, s);
            }
            for (const e of t.getAttributeKeys()) {
              const n = {
                item: t,
        ...
        _convertInsert(t, e, n = {}) {
          ...
          for (const n of Array.from(t.getWalker({ shallow: !0 })).map(Xa))
        ...
        _convertAttribute(t, e, n, i, s) {
          ...
          for (const o of t) {
            const t = {
              item: o.item,
              range: Ua._createFromPositionAndShift(
                o.previousPosition,
                o.length
              ),
              attributeKey: e,
        ...
        _createConversionApi(t, e = new Set(), n = {}) {
          const i = {
            ...
            convertChildren: t =>
              this._convertInsert(Ua._createIn(t), i, {
      ...
      function Xa(t) {
        return {
          item: t.item,
          range: Ua._createFromPositionAndShift(t.previousPosition, t.length),
        };
      }
        ...
        *getRanges() {
        ...
        setTo(...t) {
          ...
          if (('object' == typeof n && ((i = n), (n = void 0)), null === e))
            ...
            if ('in' == n) s = Ua._createIn(e);
              ...
              if (void 0 === n)
                throw new l('model-selection-setto-required-second-parameter', [
                  this,
                  e,
                ]);
            ...
            if (!fi(e))
              throw new l('model-selection-setto-not-selectable', [this, e]);
        ...
        _setRanges(t, e = !1) {
          const n = Array.from(t),
            i = n.some(e => {
              if (!(e instanceof Ua))
                throw new l('model-selection-set-ranges-not-range', [this, t]);
        ...
        setFocus(t, e) {
          if (null === this.anchor)
            throw new l('model-selection-setfocus-no-ranges', [this, t]);
      ...
      function ol(t) {
        ...
        if (i) {
          '$graveyard' == n.root.rootName &&
            (o = 'remove' == t.type ? t.sourcePosition : t.deletionPosition);
          const e = this.toRange();
          (this.start = n.start),
            (this.end = n.end),
            this.fire('change:range', e, { deletionPosition: o });
        } else
          s &&
        ...
        *getRanges() {
        ...
        restoreGravity(t) {
          if (!this._overriddenGravityRegister.has(t))
            throw new l('document-selection-gravity-wrong-restore', this, {
              uid: t,
            });
        ...
        _validateSelectionRanges(t) {
          for (const e of t)
            if (!this._document._validateSelectionRange(e))
              throw new l('document-selection-wrong-position', this, {
                range: e,
              });
        }
        _prepareRange(t) {
        ...
        *getStoredAttributes() {
        ...
        _getSurroundingAttributes() {
          ...
          if (this.isCollapsed) {
            ...
            if (
              (this.isGravityOverridden || (n = cl(i)),
              n || (n = cl(s)),
              !this.isGravityOverridden && !n)
            ) {
              let t = i;
              for (; t && !e.isInline(t) && !n; )
                (t = t.previousSibling), (n = cl(t));
            }
            if (!n) {
              let t = s;
              for (; t && !e.isInline(t) && !n; )
                (t = t.nextSibling), (n = cl(t));
            }
                  ...
                  i.on(
                    ...
                    (t, e, n) => {
                      ...
                      n.mapper.bindElements(e.item, r),
                        ...
                        (function (t, e, n, i) {
                          n.mapper.on('modelToViewPosition', r, {
                            priority: 'highest',
                          });
                          let s = null,
                            o = null;
                          ...
                          function r(t, e) {
                            const n = e.modelPosition.nodeAfter,
                              i = o.indexOf(n);
                            i < 0 ||
                              (e.viewPosition = e.mapper.findPositionIn(s, i));
                          }
            ...
            (function (t) {
              ...
              if (e.values)
                for (const n of e.values)
                  t.view[n] = pl(t.view[n], 'attribute');
                ...
                e.on(
                  ...
                  (function (t) {
                    return (e, n, i) => {
                      ...
                      if (n.item instanceof Za || n.item instanceof al)
              ...
              return n => {
                ...
                n.on(
                  ...
                  (t, e, n) => {
                    ...
                    if (r.isCollapsed && !n.consumable.consume(r, t.name))
                      return;
                    for (const e of r)
                    ...
                    l.insert(a.toViewPosition(r.start), s),
                      ...
                      r.isCollapsed ||
                        (l.insert(a.toViewPosition(r.end), o),
                        n.mapper.bindElementToMarker(o, e.markerName)),
                      t.stop();
                  }),
                  { priority: t.converterPriority || 'normal' }
                ),
              ...
              return e => {
                ...
                e.on(
                  ...
                  (t, e, i) => {
                    ...
                    if (
                      !(
                        e.item instanceof Za ||
                        e.item instanceof al ||
                        e.item.is('$textProxy')
                      )
                    )
                      return;
                    ...
                    if (e.item instanceof Za || e.item instanceof al)
                    ...
                    (function (t) {
                      return (e, n, i) => {
                        ...
                        if (o && o.getCustomProperty('addHighlight')) {
                          i.consumable.consume(n.item, e.name);
                          for (const t of Ua._createIn(n.item))
                ...
                i.on(
                  ...
                  (t, e, n) => {
                    ...
                    n.consumable.consume(o, t.name) &&
                      (ml(o, !1, n, e, i), ml(o, !0, n, e, i), t.stop());
                  }),
                  { priority: t.converterPriority || 'normal' }
                ),
                  i.on(
      ...
      function vl(t) {
        return (e, n, i = {}) => {
          ...
          for (const n of t.attributes)
            e.hasAttribute(n) && s.push(`attribute:${n}`);
          return (
            !!s.every(t => n.test(e, t)) &&
            (i.preflight || s.forEach(t => n.consume(e, t)), !0)
          );
        };
      }
      function Pl(t, e, n, i) {
      ...
      function kl(t, e, n, i) {
        ...
        return (
          !(!r || r.root == t) &&
          !!n.canReuseView(r) &&
          (s.move(s.createRangeOn(r), o.toViewPosition(Wa._createBefore(e))),
          !0)
        );
      }
          ...
          return this.add(
            (function (t) {
              ...
              const e = { view: t.view, model: t.model },
                ...
                i = Ol(Nl(e, 'end'));
              return s => {
                s.on(`element:${t.view}-start`, n, {
                  priority: t.converterPriority || 'normal',
                }),
                  s.on(`element:${t.view}-end`, i, {
                    priority: t.converterPriority || 'normal',
                  });
                const o = r.get('low'),
                  a = r.get('highest'),
      ...
      class Dl extends M {
        constructor(t, e) {
          super(),
            ...
            (this.view = new Ia(e)),
            (this.mapper = new Ha()),
            (this.downcastDispatcher = new Ja({
              mapper: this.mapper,
              schema: t.schema,
            }));
      ...
      class Fl {
        ...
        execute(t, ...e) {
          const n = this.get(t);
          if (!n)
            throw new l('commandcollection-command-not-found', this, {
              commandName: t,
            });
          return n.execute(...e);
        }
      ...
      class Bl {
        ...
        static createFrom(t, e) {
          ...
          t.is('element') && e.add(t, Bl.consumablesFromElement(t)),
      ...
      class jl extends M {
        ...
        register(t, e) {
          if (this._sourceDefinitions[t])
            throw new l('schema-cannot-register-item-twice', this, {
              itemName: t,
            });
        ...
        extend(t, e) {
          if (!this._sourceDefinitions[t])
            throw new l('schema-cannot-extend-missing-item', this, {
              itemName: t,
            });
        ...
        checkMerge(t, e) {
          if (t instanceof Wa) {
            const e = t.nodeBefore,
              n = t.nodeAfter;
            if (!(e instanceof Va))
              throw new l('schema-check-merge-no-element-before', this);
            if (!(n instanceof Va))
              throw new l('schema-check-merge-no-element-after', this);
        ...
        getLimitElement(t) {
          ...
          if (t instanceof Wa) e = t.parent;
            ...
            e = (t instanceof Ua ? [t] : Array.from(t.getRanges())).reduce(
              (t, e) => {
        ...
        *getValidRanges(t, e) {
        ...
        getNearestSelectionRange(t, e = 'both') {
          ...
          ('both' != e && 'backward' != e) ||
            (n = new La({
              boundaries: Ua._createIn(s),
              startPosition: t,
              direction: 'backward',
            })),
            ('both' != e && 'forward' != e) ||
              (i = new La({ boundaries: Ua._createIn(s), startPosition: t }));
          for (const t of (function* (t, e) {
            ...
            if (i.type == e && this.isObject(i.item))
              return Ua._createOn(i.item);
            if (this.checkChild(i.nextPosition, '$text'))
              return new Ua(i.nextPosition);
          }
          return null;
        }
        ...
        setAllowedAttributes(t, e, n) {
          ...
          for (const [s, o] of Object.entries(e))
            i.schema.checkAttribute(t, s) && n.setAttribute(s, o, t);
        }
        ...
        *_getValidRangesForRange(t, e) {
          ...
          for (const s of t.getItems({ shallow: !0 }))
            s.is('element') &&
              (yield* this._getValidRangesForRange(Ua._createIn(s), e)),
      ...
      class sc extends w {
          ...
          super(),
            ...
            this.upcastDispatcher.on(
              ...
              (t, e, { schema: n, consumable: i, writer: s }) => {
                ...
                s.insert(r, o),
                  (e.modelRange = s.createRange(
                    o,
                    o.getShiftedBy(r.offsetSize)
                  )),
        ...
        get(t = {}) {
          ...
          if (!this._checkIfRootsExists([e]))
            throw new l('datacontroller-get-non-existent-root', this);
        ...
        init(t) {
          if (this.model.document.version)
            throw new l('datacontroller-init-document-not-empty', this);
          let e = {};
          if (
      ...
      class oc {
        ...
        addAlias(t, e) {
          ...
          if (!this._upcast.includes(e) && !n)
            throw new l('conversion-add-alias-dispatcher-not-registered', this);
          this._createConversionHelpers({
            name: t,
            dispatchers: [e],
            isDowncast: n,
        ...
        for(t) {
          if (!this._helpers.has(t))
            throw new l('conversion-for-unknown-group', this);
        ...
        _createConversionHelpers({ name: t, dispatchers: e, isDowncast: n }) {
          if (this._helpers.has(t))
            throw new l('conversion-group-exists', this);
      ...
      function* ac(t, e, n) {
        if ((yield { model: t, view: e }, n))
          for (const e of pi(n)) yield { model: t, view: e };
      }
      class lc {
        constructor(t = {}) {
          'string' == typeof t &&
      ...
      class cc {
          ...
          for (const t of this._changesInElement.keys()) {
            ...
            for (const n of o)
              if ('i' === n) e.push(this._getInsertDiff(t, r, s[r])), r++;
                ...
                let l;
                if ('$text' == s[r].name)
                  l = new Ua(Wa._createAt(t, r), Wa._createAt(t, r + 1));
                else {
                  const e = t.offsetToIndex(r);
                  l = new Ua(
                    Wa._createAt(t, r),
                    Wa._createAt(t.getChild(e), 0)
                  );
                }
        ...
        _makeSnapshot(t) {
          this._elementSnapshots.has(t) ||
            this._elementSnapshots.set(t, hc(t.getChildren()));
        }
        _handleChange(t, e) {
      ...
      class fc {
        ...
        getOperations(t, e = this.version) {
          ...
          return (
            void 0 === o && (o = this._operations.length - 1),
            this._operations.slice(s, o + 1)
          );
        }
        getOperation(t) {
      ...
      class yc extends w {
        ...
        createRoot(t = '$root', e = 'main') {
          if (this.roots.get(e))
            throw new l('model-document-createroot-name-exists', this, {
              name: e,
            });
      ...
      class Pc extends w {
        ...
        _set(t, e, n = !1, i = !1) {
          ...
          if (s.includes(','))
            throw new l('markercollection-incorrect-marker-name', this);
          ...
          if (o) {
            ...
            return (
              ...
              n != o.managedUsingOperations &&
                ((o._managedUsingOperations = n), (a = !0)),
              'boolean' == typeof i &&
                i != o.affectsData &&
                ((o._affectsData = i), (a = !0)),
          ...
          const r = il.fromRange(e),
            a = new kc(s, r, n, i);
          return (
            this._markers.set(s, a),
            this.fire(`update:${s}`, a, null, e, {
              ...a.getData(),
              range: null,
            }),
            a
        ...
        _refresh(t) {
          const e = t instanceof kc ? t.name : t,
            n = this._markers.get(e);
          if (!n)
            throw new l('markercollection-refresh-marker-not-exists', this);
          const i = n.getRange();
      ...
      function Cc(t, e) {
        ...
        return (
          ...
          Sc(s, o + n.length),
          Sc(s, o),
          new Ua(t, t.getShiftedBy(i))
        );
      }
      function Ec(t) {
        if (!t.isFlat)
          throw new l('operation-utils-remove-range-not-flat', this);
        const e = t.start.parent;
        Rc(t.start), Rc(t.end);
      ...
      class Mc extends Ac {
        ...
        _validate() {
          if (!this.range.isFlat)
            throw new l('attribute-operation-range-not-flat', this);
          for (const t of this.range.getItems({ shallow: !0 })) {
            if (
              null !== this.oldValue &&
              !Ic(t.getAttribute(this.key), this.oldValue)
            )
              throw new l('attribute-operation-wrong-old-value', this, {
                item: t,
                key: this.key,
                value: this.oldValue,
              });
            if (
              ...
              throw new l('attribute-operation-attribute-exists', this, {
                node: t,
                key: this.key,
              });
          }
      ...
      class Nc extends Ac {
        ...
        _validate() {
          ...
          if (n + this.howMany > t.maxOffset)
            throw new l('move-operation-nodes-do-not-exist', this);
          if (t === e && n < i && i < n + this.howMany)
            throw new l('move-operation-range-into-itself', this);
          if (
        ...
        _execute() {
          Tc(
            Ua._createFromPositionAndShift(this.sourcePosition, this.howMany),
            this.targetPosition
          );
        }
        toJSON() {
      ...
      class Dc extends Ac {
        ...
        _validate() {
          ...
          if (!t || t.maxOffset < this.position.offset)
            throw new l('insert-operation-position-invalid', this);
        }
        _execute() {
          const t = this.nodes;
          (this.nodes = new Da([...t].map(t => t._clone(!0)))),
            Cc(this.position, t);
        }
        toJSON() {
          const t = super.toJSON();
        ...
        static fromJSON(t, e) {
          ...
          for (const e of t.nodes)
            e.name ? n.push(Va.fromJSON(e)) : n.push(Fa.fromJSON(e));
      ...
      class Vc extends Ac {
        ...
        _validate() {
          ...
          if (!(t instanceof Va))
            throw new l('rename-operation-wrong-position', this);
          if (t.name !== this.oldName)
            throw new l('rename-operation-wrong-name', this);
        }
        _execute() {
      ...
      class Lc extends Ac {
        ...
        _validate() {
          if (this.root != this.root.root || this.root.is('documentFragment'))
            throw new l('rootattribute-operation-not-a-root', this, {
              root: this.root,
              key: this.key,
            });
          if (
            ...
            throw new l('rootattribute-operation-wrong-old-value', this, {
              root: this.root,
              key: this.key,
            });
          if (
            ...
            throw new l('rootattribute-operation-attribute-exists', this, {
              root: this.root,
              key: this.key,
            });
        }
        ...
        static fromJSON(t, e) {
          if (!e.getRoot(t.root))
            throw new l('rootattribute-operation-fromjson-no-root', this, {
              rootName: t.root,
            });
          return new Lc(
            e.getRoot(t.root),
      ...
      class jc extends Ac {
        ...
        _validate() {
          const t = this.sourcePosition.parent,
            e = this.targetPosition.parent;
          if (!t.parent)
            throw new l('merge-operation-source-position-invalid', this);
          if (!e.parent)
            throw new l('merge-operation-target-position-invalid', this);
          if (this.howMany != t.maxOffset)
            throw new l('merge-operation-how-many-invalid', this);
        }
        _execute() {
          const t = this.sourcePosition.parent;
          Tc(Ua._createIn(t), this.targetPosition),
            Tc(Ua._createOn(t), this.graveyardPosition);
        }
        toJSON() {
          const t = super.toJSON();
          return (
      ...
      class Wc extends Ac {
        ...
        _validate() {
          ...
          if (!t || t.maxOffset < e)
            throw new l('split-operation-position-invalid', this);
        ...
        _execute() {
          ...
          if (this.graveyardPosition)
            Tc(
              Ua._createFromPositionAndShift(this.graveyardPosition, 1),
              this.insertionPosition
            );
          else {
            const e = t._clone();
          ...
          Tc(
            new Ua(
              Wa._createAt(t, this.splitPosition.offset),
              Wa._createAt(t, t.maxOffset)
            ),
            this.moveTargetPosition
          );
        }
        ...
        static fromJSON(t, e) {
          const n = Wa.fromJSON(t.splitPosition, e),
            ...
            s = t.graveyardPosition
              ? Wa.fromJSON(t.graveyardPosition, e)
              : null;
          return new this(n, t.howMany, i, s, t.baseVersion);
        }
      }
      ...
      class zc extends Ac {
        ...
        _validate() {
          if (this.sourcePosition.root.document)
            throw new l('detach-operation-on-document-node', this);
        }
        _execute() {
      ...
      class Uc {
        ...
        insert(t, e, n = 0) {
          if (
            (this._assertWriterUsedCorrectly(), t instanceof Fa && '' == t.data)
          )
            return;
          ...
          if (t.parent) {
            ...
            if (t.root.document)
              throw new l('model-writer-insert-forbidden-move', this);
            this.remove(t);
          }
        ...
        move(t, e, n) {
          if ((this._assertWriterUsedCorrectly(), !(t instanceof Ua)))
            throw new l('writer-move-invalid-range', this);
        ...
        remove(t) {
          this._assertWriterUsedCorrectly();
          const e = (t instanceof Ua ? t : Ua._createOn(t))
            .getMinimalFlatRanges()
            .reverse();
          for (const t of e)
            this._addOperationForAffectedMarkers('move', t),
        ...
        merge(t) {
          ...
          if (!(n instanceof Va))
            throw new l('writer-merge-no-element-after', this);
        ...
        split(t, e) {
          ...
          return {
            position: t,
            range: new Ua(Wa._createAt(n, 'end'), Wa._createAt(i, 0)),
          };
        }
        wrap(t, e) {
          if ((this._assertWriterUsedCorrectly(), !t.isFlat))
            throw new l('writer-wrap-range-not-flat', this);
          const n = e instanceof Va ? e : new Va(e);
          if (n.childCount > 0)
            throw new l('writer-wrap-element-not-empty', this);
          if (null !== n.parent)
            throw new l('writer-wrap-element-attached', this);
        ...
        unwrap(t) {
          ...
          this.move(Ua._createIn(t), this.createPositionAfter(t)),
            this.remove(t);
        }
        addMarker(t, e) {
          if (
          ...
          if (this.model.markers.has(t))
            throw new l('writer-addmarker-marker-exists', this);
          if (!i) throw new l('writer-addmarker-no-range', this);
          return n
            ? (Gc(this, t, null, i, s), this.model.markers.get(t))
        ...
        updateMarker(t, e) {
          ...
          if (!e)
            return (
              c('writer-updatemarker-reconvert-using-editingcontroller', {
                markerName: n,
              }),
          ...
          if (!s && !e.range && !o)
            throw new l('writer-updatemarker-wrong-options', this);
          const a = i.getRange(),
            h = e.range ? e.range : a;
        ...
        removeMarker(t) {
          ...
          if (!this.model.markers.has(e))
            throw new l('writer-removemarker-no-marker', this);
        ...
        _assertWriterUsedCorrectly() {
          if (this.model._currentWriter !== this)
            throw new l('writer-incorrect-use', this);
        }
          ...
          : (function (t, e) {
              ...
              if (l || c) {
                ...
                let h = n,
                  d = i;
                return (
                  s && (h = Wa._createBefore(Qc(r, e))),
                  o && (d = Wa._createAfter(Qc(a, e))),
                  new Ua(h, d)
                );
              }
              return null;
      ...
      class eh extends _(Wa) {
        constructor(t, e, n = 'toNone') {
          if ((super(t, e, n), !this.root.is('rootElement')))
            throw new l('model-liveposition-root-not-rootelement', t);
          nh.call(this);
        }
        detach() {
          this.stopListening();
        ...
        t.change(t => {
          ...
          if (!n.doNotAutoparagraph) {
            ...
            t &&
              Object.assign(
                o,
                s.getAttributesWithProperty(t, 'copyOnReplace', !0)
              );
          }
          const [r, a] = (function (t) {
            ...
            return [
              eh.fromPosition(n, 'toPrevious'),
              eh.fromPosition(i, 'toNext'),
            ];
          })(i);
      ...
      function oh(t, e, n, i) {
        ...
        if (s != i && o != i) {
          for (
            e = t.createPositionAfter(s),
              (n = t.createPositionBefore(o)).isEqual(e) || t.insert(o, e),
              t.merge(e);
            n.parent.isEmpty;
      ...
      function rh(t, e, n, i) {
        ...
        if (s != i && o != i) {
          for (
            e = t.createPositionAfter(s),
              (n = t.createPositionBefore(o)).isEqual(e) || t.insert(s, n);
            e.parent.isEmpty;
      ...
      function lh(t, e, n, i = {}) {
        ...
        t.model.schema.setAllowedAttributes(s, i, t),
          t.insert(s, e),
          ch(t, n, t.createPositionAt(s, 0));
      }
      function ch(t, e, n) {
      ...
      class dh {
        ...
        getAffectedRange() {
          return this._affectedStart
            ? new Ua(this._affectedStart, this._affectedEnd)
            : null;
        }
        destroy() {
        ...
        _appendToFragment(t) {
          if (!this.schema.checkChild(this.position, t))
            throw new l('insertcontent-wrong-position', this, {
              node: t,
        ...
        _setAffectedBoundaries(t) {
          this._affectedStart ||
            (this._affectedStart = eh.fromPosition(t, 'toPrevious')),
            (this._affectedEnd && !this._affectedEnd.isBefore(t)) ||
              (this._affectedEnd && this._affectedEnd.detach(),
              (this._affectedEnd = eh.fromPosition(t, 'toNext')));
        }
        _mergeOnLeft() {
          ...
          this._affectedStart.isEqual(e) &&
            ...
            (this._affectedStart = eh._createAt(
              e.nodeBefore,
              'end',
              'toPrevious'
            ))),
            ...
            e.isEqual(this._affectedEnd) &&
              ...
              (this._affectedEnd = eh._createAt(
                e.nodeBefore,
                'end',
                'toNext'
              ))),
        ...
        _mergeOnRight() {
          ...
          this._affectedEnd.isEqual(e) &&
            (this._affectedEnd.detach(),
            (this._affectedEnd = eh._createAt(e.nodeBefore, 'end', 'toNext'))),
            this._firstNode === this._lastNode &&
              ((this._firstNode = e.nodeBefore),
              (this._lastNode = e.nodeBefore)),
            this.writer.merge(e),
      ...
      function uh(t, e, n = 'auto') {
        ...
        return t.focus.isTouching(o)
          ? e.createRange(o)
          : e.createRange(e.createPositionBefore(s));
      }
      function fh(t, e, n, i, s = {}) {
        if (!t.schema.isObject(e))
          throw new l('insertobject-element-not-an-object', t, { object: e });
        let o;
        o = n
          ? n instanceof Za || n instanceof al
            ? n
        ...
        s.findOptimalPosition &&
          t.schema.isBlock(e) &&
          (r = t.createSelection(uh(o, t, s.findOptimalPosition)));
        ...
        change(t) {
          try {
            return 0 === this._pendingChanges.length
              ? (this._pendingChanges.push({ batch: new lc(), callback: t }),
          ...
          return (function (t, e) {
            return t.change(t => {
              ...
              if (a != i) {
                ...
                hh(t.createRange(e.end, t.createPositionAt(n, 'end')), t),
                  hh(s, t);
              }
              return n;
            });
      ...
      class vh {
        constructor(t = {}) {
          ...
          (this._context = t.context || new ki({ language: e })),
        ...
        enableReadOnlyMode(t) {
          if ('string' != typeof t && 'symbol' != typeof t)
            throw new l('editor-read-only-lock-id-invalid', null, {
              lockId: t,
            });
      ...
      class Ph {
        ...
        *names() {
        ...
        create(t) {
          if (!this.has(t))
            throw new l('componentfactory-item-missing', this, { name: t });
      ...
      class Ch {
        ...
        revert(t) {
          if (!this._revertData)
            throw new l('ui-template-revert-not-applied', [this, t]);
      ...
      function Sh(t) {
        return (
          !!t &&
          (t.value && (t = t.value),
          Array.isArray(t) ? t.some(Sh) : t instanceof Eh)
        );
      }
      function Rh(t, e, { node: n }) {
        ...
        (i = 1 == t.length && t[0] instanceof xh ? i[0] : i.reduce(Bh, '')),
          jh(i) ? e.remove() : e.set(i);
      }
      function Oh(t) {
        return {
          set(e) {
      ...
      function Dh(t) {
        if (
          ...
          t.attributes &&
            (function (t) {
              for (const e in t)
                t[e].value && (t[e].value = pi(t[e].value)), Fh(t, e);
            })(t.attributes);
          const e = [];
          if (t.children)
            if (zh(t.children)) e.push(t.children);
              ...
              for (const n of t.children)
                $h(n) || Wh(n) || Yo(n) ? e.push(n) : e.push(new Ch(n));
          t.children = e;
        }
        return t;
      }
      ...
      function Lh(t, e) {
        if (
          (e.attributes &&
            ...
            Vh(t.attributes, e.attributes)),
          e.eventListeners &&
            (t.eventListeners || (t.eventListeners = {}),
            Vh(t.eventListeners, e.eventListeners)),
          e.text && t.text.push(...e.text),
          e.children && e.children.length)
        ) {
          if (t.children.length != e.children.length)
            throw new l('ui-template-extend-children-mismatch', t);
          let n = 0;
      ...
      class Uh {
        ...
        get bindTemplate() {
          return this._bindTemplate
            ? this._bindTemplate
            : (this._bindTemplate = Ch.bind(this, this));
        }
        createCollection(t) {
          const e = new Ah(t);
        ...
        render() {
          if (this.isRendered)
            throw new l('ui-view-render-already-rendered', this);
          this.template &&
      ...
      function Hh({
        ...
        limiter: i,
        fitInViewport: s,
        viewportOffsetConfig: o,
      }) {
        Et(e) && (e = e()), Et(i) && (i = i());
        const r = (function (t) {
            return t && t.parentNode
              ? t.offsetParent === wi.document.body
                ? null
                : t.offsetParent
              : null;
          })(t),
      ...
      class Zh extends Uh {
        ...
        _stopPinning() {
          this.stopListening(wi.document, 'scroll'),
            this.stopListening(wi.window, 'resize');
        }
      }
      function Qh(t) {
        return ci(t)
      ...
      class nd {
        constructor(t) {
          ...
          (nd._instance = this),
            ...
            this.listenTo(wi.document, 'blur', this._onLeaveOrBlur.bind(this), {
              useCapture: !0,
            }),
            this.listenTo(wi.document, 'scroll', this._onScroll.bind(this), {
              useCapture: !0,
            }),
        ...
        _pinTooltip(t, { text: e, position: n, cssClass: i }) {
          ...
          s.has(this.balloonPanelView) || s.add(this.balloonPanelView),
            ...
            this.balloonPanelView.pin({
              target: t,
              positions: nd.getPositioningFunctions(n),
            }),
        ...
        _updateTooltipPosition() {
          ha(this._currentElementWithTooltip)
            ? this.balloonPanelView.pin({
                ...
                positions: nd.getPositioningFunctions(
        ...
        _initFocusTracking() {
          ...
          t.keystrokes.set('Alt+F10', (t, s) => {
            ...
            for (let t = 0; t < i.length; t++) {
              const t = i.shift();
              if (
                (i.push(t), t !== r && this._focusFocusableCandidateToolbar(t))
              ) {
      ...
      const ld = {
        updateSourceElement(t = this.data.get()) {
          if (!this.sourceElement)
            throw new l('editor-missing-sourceelement', this);
      ...
      class cd extends Ai {
        ...
        add(t) {
          if ('string' != typeof t)
            throw new l('pendingactions-add-invalid-message', this);
        ...
        attachToDom() {
          ...
          t ||
            ((t = (function (t, e, n = {}, i = []) {
              ...
              (!dd(i) && fi(i)) || (i = [i]);
              for (let e of i)
                dd(e) && (e = t.createTextNode(e)), o.appendChild(e);
              return o;
      ...
      class fd extends Uh {
        ...
        _updateXMLContent() {
          if (this.content) {
            ...
            for (e && (this.viewBox = e); this.element.firstChild; )
        ...
        _createKeystrokeView() {
          ...
          return (
            t.setTemplate({
              ...
              children: [
                { text: this.bindTemplate.to('keystroke', t => go(t)) },
              ],
            }),
            t
          );
                ...
                (-1 === n.removeItems.indexOf(t) &&
                  ('-' === t
                    ? !this.options.shouldGroupWhenFull ||
                      ...
                      !1)
                    : !!e.has(t) ||
                      (c('toolbarview-item-unavailable', { name: t }), !1)))
            ),
            s = this._cleanSeparators(i).map(t =>
              '|' === t ? new vd() : '-' === t ? new Pd() : e.create(t)
            );
      ...
      function Od(t, e = pd) {
        ...
        return (
          ...
          n instanceof pd
            ? n.bind('isOn').to(s, 'isOpen')
            : n.arrowView.bind('isOn').to(s, 'isOpen'),
          (function (t) {
            (function (t) {
              t.on('render', () => {
                !(function ({
                  ...
                  t.listenTo(document, 'mousedown', (t, s) => {
                    if (!e()) return;
                    const o =
                      'function' == typeof s.composedPath
                        ? s.composedPath()
                        : [];
                    for (const t of i)
                      if (t.contains(s.target) || o.includes(t)) return;
                    n();
                  });
                })({
                  emitter: t,
          ...
          () => {
            ...
            n &&
              ('function' == typeof n.focus
                ? n.focus()
                : c('ui-dropdown-focus-child-on-open-child-missing-focus', {
                    view: n,
                  }));
          },
          { priority: 'low' }
      ...
      class Bd extends Fd {
        constructor(t, e, n, i = {}) {
          ...
          this.extendTemplate({
            ...
            (this._generateLabel =
              i.label || (() => s('Editor editing area: %0', this.name)));
        }
        render() {
          super.render();
          const t = this._editingView;
              ...
              attributes: {
                ...
                style: {
                  ...
                  height: e.to('isSticky', t =>
                    t ? Ld(this._panelRect.height) : null
                  ),
                },
              },
            }).render()),
              ...
              attributes: {
                ...
                style: {
                  ...
                  top: e.to('_hasViewportTopOffset', t =>
                    t ? Ld(this.viewportTopOffset) : null
                  ),
                  bottom: e.to('_isStickyToTheLimiter', t =>
                    t ? Ld(this.limiterBottomOffset) : null
                  ),
      ...
      function zd(t, e) {
        ...
        let s = !1;
        for (const [t, o] of n)
          o.isDirectHost && (i.push(t), qd(e, t, o) && (s = !0));
        for (const [t, o] of n) {
          if (o.isDirectHost) continue;
          const n = Ud(t);
          n &&
            (i.includes(n) || ((o.hostElement = n), qd(e, t, o) && (s = !0)));
        }
        return s;
      }
      function qd(t, e, n) {
        ...
        o.getAttribute('data-placeholder') !== i &&
          (t.setAttribute('data-placeholder', i, o), (r = !0));
        return (
          (s || 1 == e.childCount) &&
          (function (t, e) {
          ...
          if (t instanceof Nc)
            ...
            if (e instanceof jc)
              ...
              if (
                ...
                const n = Ua._createFromPositionAndShift(
                  e.sourcePosition,
                  e.howMany
                );
                if (
            ...
            if (!n) return;
            if (e instanceof Nc) {
              const i = Ua._createFromPositionAndShift(
                  e.sourcePosition,
                  e.howMany
                ),
      ...
      Kd(Mc, Mc, (t, e, n) => {
        if (t.key === e.key && t.range.start.hasSameParentAs(e.range.start)) {
          const i = t.range
              ...
              .map(e => new Mc(e, t.key, t.oldValue, t.newValue, 0)),
            s = t.range.getIntersection(e.range);
          return (
            s &&
              n.aIsStrong &&
              i.push(new Mc(s, e.key, e.newValue, t.newValue, 0)),
            0 == i.length ? [new Bc(0)] : i
          );
        }
        return [t];
      }),
        Kd(Mc, Dc, (t, e) => {
          if (
            ...
            const n = t.range
              ...
              .map(
                e => new Mc(e, t.key, t.oldValue, t.newValue, t.baseVersion)
              );
        ...
        Kd(Mc, jc, (t, e) => {
          ...
          return (
            ...
            n.map(e => new Mc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
          );
        }),
        Kd(Mc, Nc, (t, e) => {
        ...
        Kd(Fc, Nc, (t, e, n) => {
          if (
            (t.oldRange &&
              (t.oldRange = Ua._createFromRanges(
                t.oldRange._getTransformedByMoveOperation(e)
              )),
            t.newRange)
          ) {
            if (n.abRelation) {
              const i = Ua._createFromRanges(
            ...
            t.newRange = Ua._createFromRanges(
              t.newRange._getTransformedByMoveOperation(e)
            );
          }
          return [t];
        ...
        Kd(jc, jc, (t, e, n) => {
          if (
            ...
            if (n.bWasUndone) {
              ...
              return (
                n.push(0),
                (t.sourcePosition = new Wa(e.graveyardPosition.root, n)),
                (t.howMany = 0),
                [t]
              );
            }
        ...
        Kd(Nc, Nc, (t, e, n) => {
          ...
          return (
            null !== d &&
              r &&
              ((d.start = d.start._getCombined(
                e.sourcePosition,
                e.getMovedRangeStart()
              )),
              (d.end = d.end._getCombined(
                e.sourcePosition,
                e.getMovedRangeStart()
              )),
              0 === c.length
        ...
        Kd(Nc, Wc, (t, e, n) => {
          ...
          if (e.graveyardPosition) {
            ...
            t.howMany > 1 &&
              i &&
              !n.aWasUndone &&
              o.push(Ua._createFromPositionAndShift(e.insertionPosition, 1));
          }
          return nu(o, i);
        }),
        Kd(Nc, jc, (t, e, n) => {
          ...
          if (
            ...
            if ('remove' != t.type || n.forceWeakRemove) {
              ...
              t.howMany > 1 &&
                (n.push(
                  new Nc(t.sourcePosition, t.howMany - 1, t.targetPosition, 0)
                ),
          ...
          const s = Ua._createFromPositionAndShift(
            t.sourcePosition,
            t.howMany
        ...
        Kd(Vc, Wc, (t, e) => {
          if (
            'same' == Ei(t.position.path, e.splitPosition.getParentPath()) &&
            !e.graveyardPosition
          ) {
            const e = new Vc(
        ...
        Kd(Wc, Nc, (t, e, n) => {
          ...
          return (
            ...
            t.graveyardPosition
              ...
              : (t.insertionPosition = Wc.getInsertionPosition(
                  t.splitPosition
                )),
            [t]
          );
          ...
          if (
            ...
            if ((s && !i) || (!o && n.aIsStrong)) {
              ...
              return (
                e.howMany &&
                  n.push(
                    new Nc(e.moveTargetPosition, e.howMany, e.splitPosition, 0)
                  ),
                t.howMany &&
                  n.push(
                    new Nc(t.splitPosition, t.howMany, t.moveTargetPosition, 0)
                  ),
                n
              );
            }
          ...
          s &&
            (function (t) {
              const {
                ...
                r = e.document;
              Wd.has(r) ||
                (Wd.set(r, new Map()), r.registerPostFixer(t => zd(r, t))),
                Wd.get(r).set(n, {
                  text: i,
                  isDirectHost: s,
                  keepOnFocus: o,
                  hostElement: s ? n : null,
                }),
                e.change(t => zd(r, t));
            })({
              view: e,
      ...
      class au extends vh {
        constructor(t, e = {}) {
          if (!ci(t) && void 0 !== e.initialData)
            throw new l('editor-create-initial-data', null);
          super(e),
          ...
          const n = !this.config.get('toolbar.shouldNotGroupWhenFull'),
            i = new ru(this.locale, this.editing.view, {
              shouldToolbarGroupWhenFull: n,
            });
          (this.ui = new ou(this, i)),
            (function (t) {
              if (!Et(t.updateSourceElement))
                throw new l('attachtoform-missing-elementapi-interface', t);
            ...
            this.listenTo(e, 'change:data', (t, e) => {
              this._saveCallbacks.length &&
                ...
                ('synchronized' === this.state &&
                  ((this.state = 'waiting'), this._setPendingAction()),
                'waiting' === this.state && this._debouncedSave());
            });
          }),
            this.listenTo(t, 'destroy', () => this._flush(), {
              priority: 'highest',
            }),
            this._domEmitter.listenTo(window, 'beforeunload', (t, e) => {
              this._pendingActions.hasAny &&
          ...
          return this._savePromise
            ...
            : (this._setPendingAction(),
              ...
              (this._savePromise = Promise.resolve()
                .then(() =>
                  Promise.all(this._saveCallbacks.map(t => t(this.editor)))
                )
                .finally(() => {
                  this._savePromise = null;
                })
                .then(() => {
                  if (this._makeImmediateSave)
                    return (this._makeImmediateSave = !1), this._save();
                  this.editor.model.document.version > this._lastDocumentVersion
        ...
        execute(t = {}) {
          ...
          e.change(t => {
            if (n.isCollapsed)
              ...
              const s = e.schema.getValidRanges(
                n.getRanges(),
                this.attributeKey
              );
              for (const e of s)
      ...
      class du extends j {
        ...
        init() {
          ...
          t.model.schema.extend('$text', { allowAttributes: hu }),
            t.model.schema.setAttributeProperties(hu, {
              isFormatting: !0,
              copyOnEnter: !0,
            }),
        ...
        if (t.is('$text') || t.is('$textProxy')) e = t.data;
          ...
          for (const i of t.getChildren()) {
            ...
            n &&
              ...
              (pu.includes(n.name) || pu.includes(i.name)
                ? (e += '\n')
                : (e += '\n\n')),
              (e += t),
              (n = i);
      ...
      class wu extends j {
        ...
        init() {
          this.editor.editing.view.addObserver(gu),
          ...
          t.change(n => {
            !(function (t, e, n, i) {
              ...
              if (i.isLimit(r) || i.isLimit(a))
                return void (s || r != a || t.deleteContent(n));
              if (s) {
                ...
                t.deleteContent(n, { leaveUnmerged: i }),
                  i && (s ? vu(e, n.focus) : e.setSelection(a, 0));
              }
        ...
        constructor(t) {
          ...
          e.on('keydown', (t, n) => {
            if (this.isEnabled && n.keyCode == ho.enter) {
              ...
              e.fire(i, new Wr(e, n.domEvent, { isSoft: n.shiftKey })),
      ...
      class Cu extends $ {
        constructor(t, e) {
          super(t),
            (this.direction = e),
            (this._buffer = new Au(t.model, t.config.get('typing.undoStep')));
        }
        get buffer() {
          return this._buffer;
        }
      ...
      function Iu(t, e) {
        return (
          t && e && t.priority == e.priority && Nu(t.classes) == Nu(e.classes)
        );
      }
      function Mu(t, e) {
        return (
          t.priority > e.priority ||
          (!(t.priority < e.priority) && Nu(t.classes) > Nu(e.classes))
        );
      }
      function Nu(t) {
      ...
      function Vu(t, e, n = {}) {
        if (!t.is('containerElement'))
          throw new l('widget-to-widget-wrong-element-type', null, {
            element: t,
          });
        return (
      ...
      class Zu extends j {
          ...
          this.on('change:isEnabled', (n, i, s) => {
            e.change(t => {
              for (const n of e.document.roots)
                s ? t.removeClass(Xu, n) : t.addClass(Xu, n);
            }),
              s ||
                t.model.change(t => {
        ...
        _insertParagraph(t, e) {
          const n = this.editor,
            i = n.editing.view,
            s = n.model.schema.getAttributesWithProperty(
              t,
              'copyOnReplace',
              !0
            );
          ...
          this._listenToIfEnabled(
            ...
            this._listenToIfEnabled(
              ...
              (t, e, n) => {
                ...
                l &&
                  (s.addClass(o(l), a),
                  (this._currentFakeCaretModelElement = r));
              }
            ),
            this._listenToIfEnabled(
              t.ui.focusTracker,
        ...
        _handleArrowKeyPressOnSelectedWidget(t) {
          ...
          return e.change(e => {
            if (!n)
              return e.setSelectionAttribute(qu, t ? 'after' : 'before'), !0;
            if (!(n === (t ? 'after' : 'before')))
              return e.removeSelectionAttribute(qu), !0;
            return !1;
          });
        }
          ...
          return (
            ...
            (n.change(e => {
              s._setSelectionOverElement(o),
                e.setSelectionAttribute(qu, t ? 'before' : 'after');
            }),
            !0)
          );
        }
        _handleArrowKeyPressWhenNonCollapsedSelection(t) {
          ...
          return (
            ...
            (n.change(e => {
              e.setSelection(r, 'on'),
                e.setSelectionAttribute(qu, t ? 'after' : 'before');
            }),
            !0)
          );
        }
      ...
      class nf extends j {
        ...
        init() {
          ...
          (this._previouslySelected = new Set()),
            ...
            this.listenTo(n, 'arrowKey', Qu(this.editor.editing), {
              context: '$text',
            }),
            this.listenTo(
              n,
      ...
      class rf extends j {
        ...
        init() {
          ...
          (this._draggedRange = null),
            ...
            (this._updateDropMarkerThrottled = of(
              t => this._updateDropMarker(t),
              40
            )),
            (this._removeDropMarkerDelayed = cf(
              () => this._removeDropMarker(),
              40
            )),
            (this._clearDraggableAttributesDelayed = cf(
          ...
          this.listenTo(
            ...
            (i, r) => {
              ...
              if (l) {
                ...
                (t && Bu(t)) ||
                  (this._draggedRange = il.fromRange(a.getFirstRange()));
              }
            ...
            t.plugins.get(wu).on('contentInsertion', (t, n) => {
              (o ||
                ...
                e.change(t => {
                  ...
                  s.isCollapsed ||
                    e.deleteContent(s, { doNotAutoparagraph: !0 }),
                    i.push(...s.getAttributes());
          ...
          t.change(n => {
            !(function (t, e, n) {
              ...
              if (i) {
                ...
                t.deleteContent(n, { leaveUnmerged: i }),
                  a ? mf(t, e, n.focus) : i && e.setSelection(r, 0);
              }
            })(t, n, e.selection),
              this.fire('afterExecute', { writer: n });
          });
        ...
        init() {
          ...
          t.commands.add('input', e),
            (function (t) {
              ...
              ro.isAndroid
                ? i.document.on('beforeinput', (t, e) => o(e), {
                    priority: 'lowest',
                  })
                : i.document.on('keydown', (t, e) => o(e), {
                    priority: 'lowest',
                  }),
                i.document.on(
                  'compositionstart',
      ...
      class Nf extends Rf {
        execute() {
          ...
          this.editor.model.enqueueChange(e, () => {
            const n =
                t.batch.operations[t.batch.operations.length - 1].baseVersion +
                1,
      ...
      L(
        class extends j {
          ...
          attachTo(t) {
            ...
            return (
              this.getResizerByViewElement(i) == e && (this.visibleResizer = e),
              e
            );
          }
      ...
      function nm(t, e, n, i) {
        ...
        if (((a = sm(a)), r.insert(a, s), c && 'listItem' == c.name)) {
          const t = o.toViewElement(c),
            n = r
              .createRange(r.createPositionAt(t, 0), a)
        ...
        if (n.consumable.consume(e.viewItem, { name: !0 })) {
          ...
          const o =
            e.viewItem.parent && 'ol' == e.viewItem.parent.name
              ...
              : 'bulleted';
          if (
            (t.setAttribute('listType', o, i), !n.safeInsert(i, e.modelCursor))
          )
            return;
      ...
      function bm(t, e, n, i, s, o) {
        ...
        for (const t of [...i.getChildren()])
          ym(t) &&
            ((h = l.move(l.createRangeOn(t), h).end),
            im(l, t, t.nextSibling),
            im(l, t.previousSibling, t));
      }
      function ym(t) {
                  ...
                  if ('$text' != i.name) {
                    ...
                    n.hasAttribute('listIndent') &&
                      ...
                      n.hasAttribute('listReversed') &&
                        (e.removeAttribute('listReversed', n), (s = !0)),
                      n.hasAttribute('listStart') &&
                        (e.removeAttribute('listStart', n), (s = !0));
              ...
              (t, e) => {
                ...
                if ('ul' == s.name || 'ol' == s.name) {
                  ...
                  let a = 1,
                    l = n.nodeBefore;
                  for (; l && ym(l); )
                    (a += o.getModelLength(l)), (l = l.previousSibling);
                  (e.modelPosition = i.createPositionBefore(r).getShiftedBy(a)),
                    t.stop();
                }
              })
            ),
                ...
                e.on(
                  ...
                  (function (t) {
                    return (e, n, i) => {
                      ...
                      for (const t of o.createRangeIn(c).getItems())
      ...
      function Pm(t) {
        ...
        for (const n of t.getChildren())
          if ('ul' == n.name || 'ol' == n.name)
            for (const t of n.getChildren()) e += Pm(t);
        return e;
      }
      class km extends j {
        static get pluginName() {
      ...
      class Am extends $ {
        refresh() {
          ...
          (this.value = !!e && e.is('element', 'paragraph')),
            (this.isEnabled = !!e && Cm(e, t.schema));
        }
        execute(t = {}) {
          const e = this.editor.model,
            n = e.document;
      ...
      class Em extends $ {
        execute(t) {
          ...
          e.change(t => {
            const s = t.createElement('paragraph');
            if (
              (n && e.schema.setAllowedAttributes(s, n, t),
              !e.schema.checkChild(i.parent, s))
            ) {
        ...
        init() {
          ...
          t.commands.add('paragraph', new Am(t)),
            ...
            t.conversion.for('upcast').elementToElement({
              model: (t, { writer: e }) =>
                Tm.paragraphLikeElements.has(t.name)
                  ? t.isEmpty
                    ? null
      ...
      function Rm(t, e, n) {
        ...
        return (
          ...
          t.startIndex &&
            t.startIndex > 1 &&
            n.setAttribute('start', t.startIndex, s),
          s
        );
      }
      function Om(t) {
        ...
        const n = new DOMParser(),
          i = (function (t) {
            ...
            (function (t) {
              ...
              return (
                t.substring(0, i + e.length) + (s >= 0 ? t.substring(s) : '')
              );
      ...
      class zm extends $ {
          ...
          t.change(n => {
            for (const i of this._getFormattingItems(t.document.selection, e))
              if (i.is('selection'))
                ...
                for (const s of this._getFormattingAttributes(i, e))
                  n.removeAttribute(s, t);
              }
          });
        }
        *_getFormattingItems(t, e) {
          ...
          for (const i of t.getRanges())
            for (const t of i.getItems()) !e.isBlock(t) && n(t) && (yield t);
                  ...
                  ? (s ||
                      ...
                      (function (t, e) {
                        ...
                        i.items.bindTo(e).using(({ type: t, model: e }) => {
                          ...
                          Id(t, () =>
                            i.items.find(
                              t => t instanceof Sd && t.children.first.isOn
                            )
                          );
                      })(i, s)),
                    (i.class = ''),
                    s.map(t => {
                      (t.model.class = r ? '' : 'ck-hidden'),
                        'WProofreaderToggle' === t.model.commandParam &&
                          ((t.model.label = r
                            ? t.model.localization.disable
                            : t.model.localization.enable),
                          (t.model.class = ''));
                    }))
      ...
      class tg {
        ...
        _create() {
          (window.WPROOFREADER_SRCSTORAGE =
            window.WPROOFREADER_SRCSTORAGE || {}),
      ...
      class eg {
        constructor(t) {
          this._validateSrc(t),
            (this._src = t),
            (this._globalSrcStorage = new tg());
        }
        load() {
          return new Promise((t, e) => {
            this._isScriptOnPage()
              ? this._processExistingScript(t, e)
              : this._createScript(t, e);
          });
        }
        _validateSrc(t) {
        ...
        _processExistingScript(t, e) {
          this._globalSrcStorage.has(this._src)
            ? this._addCallbacks(t, e)
            : this._processLoadedScript(t);
        }
        _addCallbacks(t, e) {
          this._globalSrcStorage.addCallbacks(this._src, t, e);
        }
      ...
      (ig.builtinPlugins = [
        ...
        class extends j {
          ...
          init() {
            (this._userOptions = this._getUserOptions()),
              ...
              this.bind('isToggleCommandEnabled').to(
                this.editor.commands.get('WProofreaderToggle'),
                'isEnabled',
                t => this._handleToggleCommandEnabled(t)
              );
          }
          destroy() {
            super.destroy(),
          ...
          _setAutoStartup() {
            this._userOptions.hasOwnProperty('autoStartup') ||
              (this._userOptions.autoStartup = !0);
          }
          _setIsEnabled(t, e) {
          ...
          _checkCollaborationMode() {
            for (let t = 0; t <= this._collaborationPluginNames.length; t++)
              if (this.editor.plugins.has(this._collaborationPluginNames[t]))
                return !0;
            return !1;
          }
          _createOptions() {
          ...
          _createInstance(t) {
            WEBSPELLCHECKER.init(
              ...
              this._handleInstanceCreated.bind(this)
            );
          }
          _mergeOptions(t) {
          ...
          _handleInstanceCreated(t) {
            t &&
              ('destroyed' !== this.editor.state
                ? (this.isEnabled || this._disableInstance(t),
          ...
          _handleToggleCommandEnabled(t) {
            return (
              this._setIsEnabled(t, 'WProofreaderToggleCommandDisabling'),
              this._syncToggle(t),
              t
            );
          }
          getStaticActions() {
            return 0 === this._instances.length
              ? []
              : this._instances[0].getStaticActions();
          }
          toggle() {
          ...
          isInstancesEnabled() {
            return (
              0 !== this._instances.length && !this._instances[0].isDisabled()
            );
          }
        },
      ]),
